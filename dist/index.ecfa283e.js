...
})({"k30yb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cbcd8fd5ecfa283e";
"use strict";
...
},{}],"4dW60":[function(require,module,exports) {
...
(0, _jqueryDefault.default)(document).ready(function() {
  ...
  `;
    ...
    function changeModal(title, description) {
        (0, _jqueryDefault.default)(".modal-title").text(title);
        (0, _jqueryDefault.default)(".modal-body").text(description);
    }
    // Функция показа модального окна на клик по карточке и перехода между модальными окнами с помощью стрелок
    (0, _jqueryDefault.default)(".card").click(function() {
        changeModal((0, _jqueryDefault.default)(this).find(".card-title").text(), (0, _jqueryDefault.default)(this).find(".card-body").text());
        var modal = new (0, _bootstrapDefault.default).Modal((0, _jqueryDefault.default)(".modal"));
        modal.show();
        // Находим какое модальное окно открыто в данный момент
        var current;
        var cards = document.getElementsByClassName("card");
        for(var i = 0; i < cards.length; i++)if (this == cards[i]) current = i;
        // Отслеживаем нажатия
        window.addEventListener("keydown", function(event) {
            if (event.keyCode == "39") {
                if (current + 1 < cards.length) current = current + 1;
                else current = 0;
                changeModal((0, _jqueryDefault.default)(cards[current]).find(".card-title").text(), (0, _jqueryDefault.default)(cards[current]).find(".card-text").text());
            }
            if (event.keyCode == "37") {
                if (current - 1 > 0) current = current - 1;
                else current = cards.length - 1;
                changeModal((0, _jqueryDefault.default)(cards[current]).find(".card-title").text(), (0, _jqueryDefault.default)(cards[current]).find(".card-text").text());
            }
        });
    });
    (0, _jqueryDefault.default)(".btn").click(function() {
        var toast = new (0, _bootstrapDefault.default).Toast((0, _jqueryDefault.default)(".toast"));
        toast.show();
    });
});

},{"jquery":"hgMhh","bootstrap/dist/js/bootstrap":"9AxfY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
/*!
  ...
  */ (function(global, factory) {
    module.exports = factory(require("61c7c8eeb6cb4357"));
...
},{"61c7c8eeb6cb4357":"7unqC"}],"7unqC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["k30yb","4dW60"], "4dW60", "parcelRequire94c2")

//# sourceMappingURL=index.ecfa283e.js.map
